...
export default function SixStepsGuide() {
  return (
    <div className="mb-10 bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl px-8 py-10 text-white">
      {/* Header */}
      <div className="text-center mb-8">
        <h2 className="text-2xl font-bold mb-3">从零到百万粉丝：6步打造爆款账号</h2>
        <p className="text-slate-400 max-w-3xl mx-auto">
          深度学习全网超过 1000 万粉丝不同赛道账号的商业策略，只需 10 分钟，立即找到你适合的赛道以及差异化的内容！
        </p>
      </div>
