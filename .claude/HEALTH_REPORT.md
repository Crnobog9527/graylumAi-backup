...
> **2026-01-11 最新更新：新增 3 个 P0 紧急问题**
>
> 之前修复的问题未完全生效，新增严重问题

### P0 紧急（⚡ 今天内）

#### 🆕 1. 对话历史不显示在侧边栏 (100% 复现)
...
**相关文件**：
- `src/hooks/useChatState.js` L77-84, L473-476
- `functions/smartChatWithSearch.ts` L707-731
- `src/utils/chatAPI.js` L60-88
...
**相关文件**：
- `src/hooks/useChatState.js` L255-267, L301-314, L392-397
- `functions/smartChatWithSearch.ts` L483-543

---

#### 🆕 3. 功能模块不自动发送用户提示词 (100% 复现)
...
**相关文件**：
- `src/hooks/useChatState.js` L218-240
