...
>
> 之前尝试修复的两个问题出现新情况：
> - **对话历史不显示** - ❌ 完全没解决，对话仍不保存在侧边栏
> - **系统提示词问题** - ⚠️ 部分解决，但出现跨对话串联新问题
>
> **新增 3 个 P0 紧急问题**，必须立即处理：
>
> | # | 问题 | 复现率 | 影响 |
> |---|------|--------|------|
> | 1 | 对话历史不显示在侧边栏 | 100% | 所有对话不可见 |
> | 2 | 系统提示词跨对话串联 | 100% | 对话隔离失败 |
> | 3 | 功能模块不自动发送用户提示词 | 100% | 模块功能失效 |
>
> **处理时限**：⚡ 立即处理（今天内）
